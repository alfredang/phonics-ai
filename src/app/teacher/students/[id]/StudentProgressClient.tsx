...
export default function StudentProgressClient({ studentId }: StudentProgressClientProps) {
  ...
  const worldProgress = WORLDS.map((world) => {
    ...
    return {
      ...
      total: world.lessonCount,
      percentage: Math.round((completedInWorld / world.lessonCount) * 100),
    };
  });
